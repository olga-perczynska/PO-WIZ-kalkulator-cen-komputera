namespace PO_WIZ_kalkulator_cen_komputera
{
    partial class Form3
    {
        ...
        {
            ListViewItem listViewItem1 = new ListViewItem(new string[] { " Iiyama G-Master ", "679" }, -1);
            ListViewItem listViewItem2 = new ListViewItem(new string[] { "Iiyama G-Master Red Eagle", "1389" }, -1);
            ListViewItem listViewItem3 = new ListViewItem(new string[] { "ASUS VU279CFE-B", "849" }, -1);
            ListViewItem listViewItem4 = new ListViewItem(new string[] { " Dell U2723QE", "450" }, -1);
            ListViewItem listViewItem5 = new ListViewItem(new string[] { "Samsung Odyssey G5", "1298" }, -1);
